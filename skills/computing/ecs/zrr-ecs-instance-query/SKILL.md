---
name: zrr-ecs-instance-query
description: "Query Huawei Cloud ECS instance list and details."
---

# zrr ecs instance query | sed 's/  / /g'

## Overview

Query Huawei Cloud ECS instance list and details.
